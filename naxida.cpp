...
void Welcome()
{
	...
	tplayr.top = sheight /4;
	tplayr.bottom = tplayr.top + textheight(tplay);

	texitr.left = swidth / 2 - textwidth(texit) / 2;
	texitr.right = texitr.left + textwidth(texit);
	texitr.top = sheight / 2;
...
bool Play()
{
	...
	loadimage(&heroimg, _T("./images/laoda.png"));
	loadimage(&enemyimg, _T("./images/kun.png"));
	loadimage(&bkimg, _T("./images/majiaqi.png"));
	loadimage(&bulletimg, _T("./images/qiu.png"));
